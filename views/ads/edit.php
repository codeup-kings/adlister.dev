		...
		<div class="row">
			...
			<div class="col-sm-6 col-sm-offset-3">
				...
				<form action="" method="POST" enctype="multipart/form-data" data-validation data-required-message="">
					...
					<div class="form-group">
					    <input type="text" class="form-control" id="price" price="price" placeholder="Price" value="<?=$item->price; ?>" data-required data-validate="currency" data-message="Price must be number/s with decimals.">
					</div>	
					<div class="form-group">
